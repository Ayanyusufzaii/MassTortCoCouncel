...
const eligibilityCards = [
  {
    ...
    text: (
      <>
        ...
        <span className="text-[#ED8B03]"> Port Catheter</span> Implanted
      </>
    ),
    bg: "bg-[#FDF9ED]",
  },
  {
    ...
    text: (
      <>
        Experienced
        <span className="text-[#ED8B03]"> Infection, Breakage, Migration</span>, Or
        <span className="text-[#ED8B03]"> Required Revision Surgery</span>
      </>
    ),
    bg: "bg-[#F3F4F9]",
  },
  {
    ...
    text: (
      <>
        Were
        <span className="text-[#ED8B03]"> Hospitalized</span> Or
        <span className="text-[#ED8B03]"> Suffered Long-Term Complications</span>
      </>
    ),
    bg: "bg-[#F3F4F9]",
  },
  {
    ...
    text: (
      <>
        <span className="text-[#ED8B03]">Were Not Informed</span> Of The Device’s
