...
const eligibilityCards = [
  {
    ...
    text: (
      <>
        You worked as a<span className="text-[#ED8B03]"> firefighter </span>, military member, airport worker, or in industrial fire safety
      </>
    ),
    bg: "bg-[#FDF9ED]",
  },
  {
    ...
    text: (
      <>
        You were<span className="text-[#ED8B03]"> regularly exposed to AFFF </span>during training or fire suppression
  ...
  },
  {
    ...
    text: (
      <>
      You were<span className="text-[#ED8B03]"> diagnosed with one of the cancers </span>or illnesses above
  ...
  },
  {
    ...
    text: (
      <>
        Your diagnosis<span className="text-[#ED8B03]"> occurred within a reasonable period </span>after PFAS exposure
  ...
  },
  {
    ...
    text: (
      <>
        You are within<span className="text-[#ED8B03]"> your state’s legal timeframe </span>to file
      </>
