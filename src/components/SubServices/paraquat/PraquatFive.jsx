...
const eligibilityCards = [
  {
    ...
    text: (
      <>
        Worked in <span className="text-[#ED8B03]">farming, landscaping, or chemical application</span>
      </>
    ),
    bg: "bg-[#FDF9ED]",
  },
  {
    ...
    text: (
      <>
        Were exposed to Paraquat through<span className="text-[#ED8B03]"> mixing, spraying, or contact</span>
  ...
  },
  {
    ...
    text: (
      <>
        Were later diagnosed with <span className="text-[#ED8B03]"> Parkinson’s disease</span>
  ...
  },
  {
    ...
    text: (
      <>
        Are within your <span className="text-[#ED8B03]"> state’s filing deadline</span>
      </>
...
export default function PraquatFive() {
  return (
    <section
