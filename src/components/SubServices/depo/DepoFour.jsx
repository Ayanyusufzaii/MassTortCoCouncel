...
const lawsuitCards = [
  {
    ...
    description: (
      <>
        Hormone-sensitive
        <span className="text-[#1545B5]"> brain tumors</span>
      </>
    )
  },
  {
    ...
    description:(
      <>
        Severe bone mineral
        <span className="text-[#1545B5]"> density loss</span>, often irreversible
      </>
    )
  },
  {
    ...
    description: (
      <>
        Increased
        <span className="text-[#1545B5]"> skull pressure </span> that mimics brain tumors
      </>
    )
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2 className="text-[#1545B5] text-[16px] md:text-[25px] lg:text-[22px] xl:text-[35px] font-semibold leading-[110%] capitalize mb-2 md:mb-3 lg:mb-4 text-left">
            Overview of the
            <span className="text-[#ED8B03]"> Depo-Provera <br />Brain Tumor{' '}Lawsuit</span>
          </h2>
        ...
        >
          <h3 className="text-[#1545B5] text-[16px] md:text-[25px] lg:text-[22px] xl:text-[35px] font-semibold leading-[110%] capitalize mb-2 md:mb-3 lg:mb-4 text-left">
            Lawsuits allege that Pfizer failed
            to <span className="text-[#ED8B03]">properly warn</span> women about
          </h3>
          <p className="text-[#757575] text-[10px] md:text-[11px] lg:text-[12px] xl:text-[18px] font-medium leading-[140%] mb-2 md:mb-3 lg:mb-4 xl:mb-6 text-left">
          ...
          <div className="flex flex-col gap-2 md:gap-3 lg:gap-4">
            {lawsuitCards.map((card) => (
              ...
              >
                <h4 className="text-[#1545B5] text-[12px] md:text-[16px] lg:text-[16px] xl:text-[20px] font-semibold leading-tight mb-1 md:mb-2 lg:mb-2 capitalize">
                  {card.title}
                </h4>
      ...
      <div className="md:hidden flex flex-col w-full gap-6 px-2 py-25">
        <h2 className="text-[#1545B5] text-[24px] sm:text-[24px] md:text-[30px] font-semibold leading-[1.2] capitalize text-left md:text-left tracking-[-0.28px] whitespace-nowrap px-0 pt-10 pb-4
          min-[350px]:text-[26px]
          min-[420px]:text-[30px]
        ">
          Overview of 
        ...
        <h2 className="text-[#1545B5] text-[24px] sm:text-[30px] md:text-[30px] font-semibold leading-[1.2] capitalize text-left tracking-[-0.28px]
           min-[350px]:text-[26px]
           min-[420px]:text-[30px]
        ">
        ...
        <div className="flex flex-col gap-4 pb-12">
          {lawsuitCards.map((card) => (
            ...
            >
              <h4 className="text-[#1545B5] text-[20px] font-semibold leading-normal mb-2">
                {card.title}
              </h4>
    ...
    <h3 className="text-[24px] md:text-[22px] lg:text-[24px] xl:text-[29px] font-medium text-[#1545B5] mb-3 md:mb-4 lg:mb-5 xl:mb-0 md:leading[1.2] lg:leading-[1.2] ">
