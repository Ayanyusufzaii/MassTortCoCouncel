...
const eligibilityCards = [
  {
    ...
    text: (
      <>
        ...
        <span className="text-[#ED8B03]">6 Months Or Longer</span>
      </>
    ),
    bg: "bg-[#FDF9ED]",
  },
  {
    ...
    text: (
      <>
        <span className="text-[#ED8B03]">Were Diagnosed</span> With Meningioma,
  ...
  },
  {
    ...
    text: (
      <>
        <span className="text-[#ED8B03]">Symptoms</span> Like Vision Problems,
  ...
  },
  {
    ...
    text: (
      <>
        Are Still <span className="text-[#ED8B03]">Within Your State's</span>{" "}
    ...
    >
     ...
     <div className="hidden lg:grid max-w-[1200px] mx-auto grid-cols-[420px_auto] xl:grid-cols-[450px_auto] gap-x-[48px] xl:gap-x-[60px] gap-y-12 px-4 lg:px-6 items-center">
        <div className="max-w-[405px] flex flex-col justify-center">
          <h2 className="text-[#1545B5] text-[32px] xl:text-[40px] font-semibold capitalize leading-[1.2]">
            You May <span className="text-[#ED8B03]">Qualify<br></br> To File </span><span className="text-[#1545B5]">A Lawsuit<br /> If You...!</span>
          </h2>
  ...
  {' '}above<br />to check eligibility at no cost.
        ...
        <div className="grid grid-cols-2 gap-x-[28px] xl:gap-x-[32px] gap-y-4 justify-start ml-[-20px] xl:ml-[-32px]">
          {eligibilityCards.map((card) => (
            ...
            >
              <span className="text-[#1545B5] font-[Quicksand] not-italic font-medium leading-none text-[25px] xl:text-[28px]">
                {card.number}
              </span>
              <p className="text-[#1545B5] text-[12px] xl:text-[13px] font-medium leading-none tracking-[-0.32px] capitalize text-left">
                {card.text}
              </p>
            </article>
          ))}
      ...
      <div className="hidden md:flex lg:hidden max-w-[1200px] mx-auto flex-col items-center gap-6 px-4 py-2 md:gap-6 xl:gap-8">
        <div className="w-full text-center -mt-8">
          <h2 className="text-[#1545B5] text-[28px] lg:text-[32px] font-semibold capitalize leading-normal">
            ...
            <br />
            <span className="text-[#1545B5]">A Lawsuit If You...!</span>
          </h2>
          <p className="text-[#757575] text-[13px] xl:text-[14px] font-medium leading-[20px] xl:leading-[22px]">
            Unsure?{" "}
            <a
        ...
        <div className="grid grid-cols-2 gap-5">
          {eligibilityCards.map((card) => (
            ...
            >
              <span className="text-[#1545B5] font-[Quicksand] not-italic font-normal leading-none text-[20px]">
                {card.number}
              </span>
              <p className="text-[#1545B5] text-[14px] lg:text-[15px] xl:text-[16px] font-medium leading-none tracking-[-0.32px] capitalize text-left">
                {card.text}
              </p>
            </article>
          ))}
      ...
      <div className="md:hidden flex flex-col  gap-6 px-4">
        <h2 className="text-[#1545B5] text-[30px] font-semibold capitalize leading-snug text-left">
          You May <span className="text-[#ED8B03]">Qualify</span>{" "}
          <span className="text-[#ED8B03]">To</span>{" "}
          <span className="text-[#ED8B03]">File</span> A Lawsuit If You
        </h2>
          <p className="text-[#757575] text-[13px] xl:text-[14px] font-medium leading-[20px] xl:leading-[22px]">
            Unsure?{" "}
            <a
        ...
        <div className="flex flex-col gap-5 w-full items-center justify-center">
          {mobileEligibilityCards.map((card) => (
            ...
            >
              <span className="text-[#1545B5] text-[35px] font-normal font-[Quicksand] leading-none">
                {card.number}
              </span>
              <p className="text-[#1545B5] text-[16px] font-medium font-[Quicksand] leading-none tracking-[-0.32px] capitalize">
                {card.text}
              </p>
            </article>
          ))}
