...
//             <h2 className="text-[28px] xs:text-[24px] sm:text-[26px] font-quicksand font-semibold text-[#162766] mb-2 leading-[30px] xs:leading-[32px] sm:leading-[36px] capitalize text-left">
//               Experienced <span className="text-[#FFC928] font-quicksand font-semibold capitalize">Legal Teams</span>
//               <br />
//               <span className="text-[#162766] font-quicksand font-semibold capitalize">Who Work For You</span>
//             </h2>
...
//             </div>
//             <h2
//               className="text-[24px] sm:text-[32px] md:text-[40px] lg:text-[48px] xl:text-[56px] 2xl:text-[64px] font-quicksand font-semibold text-[#162766] mb-4 leading-[32px] sm:leading-[44px] md:leading-[54px] lg:leading-[64px] xl:leading-[72px] 2xl:leading-[80px] capitalize"
//             >
//               Experienced <span className="text-[#FFC928] font-quicksand font-semibold capitalize">Legal Teams</span>
//               <br />
//               <span className="text-[#162766] font-quicksand font-semibold capitalize">Who Work For You</span>
      ...
      <div className="relative max-w-[1200px] 2xl:max-w-[1400px] w-full mx-auto px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10 2xl:px-12">
        ...
        <div className="hidden md:flex w-full items-center pt-6 md:pt-8 lg:pt-10 xl:pt-12  md:gap-8 xl:gap-[8rem]">
          ...
          <div className="w-1/2 flex flex-col justify-center">
            ...
            <h2 className="text-[28px] lg:text-[36px] xl:text-[40px] font-semibold text-[#162766] leading-snug mb-4">
        ...
        <div className="flex flex-col md:hidden w-full pt-6 px-4 bg-[#F3F4F9]">
          ...
          <div className="w-full mb-4">
            ...
            <h2 className="text-[24px] min-[350px]:text-[26px] sm:text-[28px] font-semibold text-[#162766] leading-snug mb-2">
              Experienced{" "}
