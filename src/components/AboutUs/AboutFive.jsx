...
import bgImg from '../../assets/mapssimagee.png'
import bgImgL from '../../assets/MAAP.png'
import dots from '../../assets/dots.png'
import map from '../../assets/mapmobilee.png'
...
const AboutFive = () => {
          ...
          <div className="absolute inset-0 flex items-center justify-start z-10
            ...
            <div className="w-full">
              ...
              <h1 className="mb-2
                ...
                <span className="text-[#1545B5]">Our </span><span className="text-[#ED8B03]">Network</span>
              </h1>
  ...
  Mass Tort Co-counsel partners with vetted law firms that focus on mass torts and personal injury cases across the United States. These firms work on a contingency basis, meaning you pay nothing unless compensation is awarded.
</p>
      ...
      <section className="flex sm:hidden relative w-full h-[568px] flex-col items-start justify-between bg-white overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col items-start w-full px-4 pt-[97px]">
          <h1 className="text-[#1545B5] mb-4 text-left capitalize text-[32px] leading-[22px] font-[Quicksand] font-bold">
            Our <span className="text-[#ED8B03]">Network</span>
          </h1>
