...
<section className="hidden lg:block py-12 lg:py-16">
  ...
  <div className="bg-[#1545B5] relative rounded-2xl lg:rounded-3xl 
...
<div className="flex items-end justify-start 
  ...
  <div className="flex flex-col justify-center w-[380px] sm:w-[440px] md:w-[480px] lg:w-[520px] xl:w-[559px] gap-4">
    ...
    <Link to="/Services">
      <button className="bg-[#ED8B03] hover:bg-[#ED8B03] text-white font-semibold px-8 py-4 rounded-lg text-lg transition-colors duration-200 shadow-lg hover:shadow-xl">
      ...
      <section className="hidden md:block lg:hidden py-12">
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-[#1545B5] rounded-2xl p-8 shadow-2xl">
            {/* Tablet Image on Top */}
...
<section
  className="relative sm:hidden flex flex-col items-center justify-end
             bg-[#1545B5] w-full pt-[50px] pb-[35px]"
>
